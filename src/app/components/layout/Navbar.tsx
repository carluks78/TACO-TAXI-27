...
export default function Navbar() {
  ...
  return (
    <>
      {/* ── Scrolling top bar ── */}
      <div className="overflow-hidden" style={{ background: "#D4AF37", height: "34px" }}>
        <div className="animate-marquee h-full flex items-center text-xs font-medium" style={{ color: "#0B0B0B" }}>
          {[0, 1].map((n) => (
