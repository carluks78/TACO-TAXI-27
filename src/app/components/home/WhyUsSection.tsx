...
const reasons = [
  ...
  },
  {
    ...
    desc: "Chauffeur expérimenté, courtois et connaissant parfaitement Pacy-sur-Eure, Vernon, Évreux et toute la vallée de l'Eure.",
  },
  {
    icon: HeartHandshake,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map(({ icon: Icon, title, desc }, i) => (
            ...
            >
              <div className="flex-shrink-0 w-11 h-11 bg-gold/10 rounded-lg flex items-center justify-center">
