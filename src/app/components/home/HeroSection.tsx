  ...
  return (
    <section className="relative min-h-[88vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImg}
          alt="TACO TAXI – Taxi Chaignes dessert Pacy-sur-Eure, Vallée de l'Eure, Normandie"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-navy-dark/95 via-navy-dark/85 to-navy-dark/30" />
        {/* Teal accent gradient overlay at bottom */}
        <div
          className="absolute bottom-0 left-0 right-0 h-32"
          style={{ background: `linear-gradient(to top, rgba(58,180,177,0.12), transparent)` }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        ...
        >
          ...
          <div
            ...
            style={{ background: "rgba(58,180,177,0.15)", borderColor: "rgba(58,180,177,0.4)" }}
          >
          ...
          {/* Rating badge */}
          <div className="inline-flex items-center gap-2 bg-gold/20 border border-gold/30 rounded-full px-4 py-1.5 mb-6 ml-2">
...
>
  Votre <strong>taxi à Pacy-sur-Eure</strong> disponible 24h/24 et 7j/7 pour tous vos déplacements :
  gare de Vernon, aéroports Roissy CDG et Orly, transport médical conventionné CPAM,
  longues distances vers Paris, Rouen et toute la Normandie.{" "}
