...
import { Phone, Clock, Shield, Car, MapPin, CheckCircle2, Heart, AlertCircle } from "lucide-react";
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            {data.cpam && (
              <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 px-6 py-4 rounded-full">
                ...
                <span style={{ fontFamily: "var(--font-body)" }} className="text-white font-semibold text-sm">
                  Conventionné CPAM — Tiers Payant
                </span>
              </div>
            )}
          </div>
